...
# define config.name = _("The Heart of Death")
define config.name = _("Сердце смерти")
...
define gui.about = _p("""
    {size=+2}{b}О игре{/b}{/size}

    Добро пожаловать в захватывающий мир нашей виртуальной новеллы! Встречайте наш творческий коллектив:

    {b}Сценарист, спрайтер:{/b} {a=https://vk.com/emoneko/}LoliGift{/a} \n
    {b}Программист:{/b} {a=https://vk.com/disooloo/}Disooloo{/a}

    Присоединяйтесь к нашей {a=https://vk.com/deaths_heart} официальной группе в VK{/a} для всех последних обновлений и интересных материалов.

    Надеемся, что наше произведение приносит вам радость и удовлетворение. Спасибо за ваш интерес к нашей игре!
""")
...
# define build.name = "TheHeartofDeath"
define build.name = "HeartDeath"
...
define config.save_directory = "TheHeartofDeath-1702311222"
...
init python:
    # Добавил звуковой канал
    renpy.music.register_channel("ambient", loop=True)
