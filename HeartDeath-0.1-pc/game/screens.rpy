...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Начать") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action Start()

        else:

            textbutton _("История") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action ShowMenu("history")

            textbutton _("Сохранить") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action ShowMenu("save")

        textbutton _("Загрузить") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action ShowMenu("load")

        textbutton _("Настройки") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action ShowMenu("preferences")
        textbutton _("Персонажи") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action ShowMenu("characters_list")

        if _in_replay:

            textbutton _("Завершить повтор") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action EndReplay(confirm=True)

        elif not main_menu:

            textbutton _("Главное меню")  hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action MainMenu()

        textbutton _("Об игре") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action ShowMenu("about")

        if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):

            ## Помощь не необходима и не относится к мобильным устройствам.
            textbutton _("Помощь") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action ShowMenu("help")

        if renpy.variant("pc"):

            ## Кнопка выхода блокирована в iOS и не нужна на Android и в веб-
            ## версии.
            textbutton _("Выход") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action Quit(confirm=not main_menu)
...
screen main_menu():
    ...
    vbox:
        ...
        textbutton _("{font=font/HeinrichScript.ttf}{size=100}Новая игра{/size=100}{/font=font/monotypecorsiva.ttf}") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action Start() at button1
        textbutton _("{font=font/HeinrichScript.ttf}{size=100}Продолжить{/size=100}{/font=font/monotypecorsiva.ttf}") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action ShowMenu("load") at button2
        textbutton _("{font=font/HeinrichScript.ttf}{size=100}Настройки{/size=100}{/font=font/monotypecorsiva.ttf}") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action ShowMenu("preferences") at button3
        textbutton _("{font=font/HeinrichScript.ttf}{size=100}Персонажи{/size=100}{/font=font/monotypecorsiva.ttf}") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action ShowMenu("characters_list") at button4
        textbutton _("{font=font/HeinrichScript.ttf}{size=100}Об игре{/size=100}{/font=font/monotypecorsiva.ttf}") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action ShowMenu("about") at button5
        textbutton _("{font=font/HeinrichScript.ttf}{size=100}Выход{/size=100}{/font=font/monotypecorsiva.ttf}") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action Quit(confirm=True) at button6
    ...
    vbox:
        ...
        imagebutton:
            xpos 0 ypos 0
            xsize 450 ysize 450
            idle "images/interface/main_meny/heart.png"
            # hover "gui/ui/new_game_hover.png"
            focus_mask True
            at buttonheart
...
screen game_menu(title, scroll=None, yinitial=0.0):
    ...
    textbutton _("Вернуться"):
        style "return_button"
        hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg"
        action Return()
            ...
            hbox:
                ...
                if renpy.variant("pc") or renpy.variant("web"):
                    ...
                    vbox:
                        ...
                        textbutton _("Оконный") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action Preference("display", "window")
                        textbutton _("Полный") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action Preference("display", "fullscreen")

                vbox:
                    style_prefix "check"
                    label _("Пропуск")
                    textbutton _("Всего текста") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action Preference("skip", "toggle")
                    textbutton _("После выборов") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action Preference("after choices", "toggle")
                    textbutton _("Переходов") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action InvertSelected(Preference("transitions", "toggle"))
                    ...
                    if config.has_sound:
                        ...
                        hbox:
                            ...
                            if config.sample_sound:
                                textbutton _("Тест") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action Play("sound", config.sample_sound)
                    ...
                    if config.has_voice:
                        ...
                        hbox:
                            ...
                            if config.sample_voice:
                                textbutton _("Тест") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action Play("voice", config.sample_voice)
    ...
    use game_menu(_("Помощь"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton _("Клавиатура") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action SetScreenVariable("device", "keyboard")
                textbutton _("Мышь") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action SetScreenVariable("device", "mouse")

                if GamepadExists():
                    textbutton _("Геймпад") hover_sound "audio/sound/btn_hover.ogg" activate_sound "audio/sound/btn_click.ogg" action SetScreenVariable("device", "gamepad")
...
screen characters_list():

    tag menu

    python:
        lockedSlod = maxCountAchive - len(persistent.AddAllAchieve)

    use game_menu("Персонажи", scroll="viewport"):
        grid 2 5:
            xspacing 250
            yspacing 30
            for id, item in allAchievements.items():
                if id in persistent.AddAllAchieve:
                    frame:
                        xysize(410, 180)
                        add item xalign .5 yalign 1.0
                        textbutton "Обзор" xalign .9 yalign 1 action [Show("characters_modal", character_name=id), Hide("characters_list")]


            for index in range(lockedSlod):
                frame:
                    xysize(410, 180)
                    add "cards/lockedSlodImage.png"

# Создаем новый screen для модального окна
screen characters_modal(character_name):
    tag menu
    python:
        # Устанавливаем значение по умолчанию, если character_name не совпадает с ожидаемыми
        image_path = "cards/lockedSlodImage.png"

        if character_name == "Элис":
            image_path = "alice_profile"
        elif character_name == "Хаулис":
            image_path = "howlis_profile"
        elif character_name == "Мистер Фойр":
            image_path = "foir_profile"
        elif character_name == "Мириам":
            image_path = "miriam_profile"

    frame:
        xysize(1920, 1080)
        add "cards/profile/" + image_path + ".png" xalign 0.5

        # text "[character_description]" xalign 0.5
        textbutton "Закрыть" action [Hide("сharacters_modal"), Show("characters_list")]
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            # textbutton _("Назад") action Rollback()
            # imagebutton "images/interface/quick_menu"
            textbutton _("История") action ShowMenu('history')
            textbutton _("Пропуск") action Skip() alternate Skip(fast=True, confirm=True)
            textbutton _("Авто") action Preference("auto-forward", "toggle")
            textbutton _("Б.Сохр") action QuickSave()
